...
call piccolo#Color('CursorLine', s:ultrablack, s:yellowgreen)
call piccolo#Color('CursorLineNr', s:ultrablack, s:yellowgreen)
call piccolo#Color('Keyword', s:purple)
call piccolo#Color('Boolean', s:lemon)
call piccolo#Color('Character', s:green)
call piccolo#Color('Number', s:darkgreen)
call piccolo#Color('String', s:brown)
call piccolo#Color('Float', s:yellowgreen)
call piccolo#Color('Conditional', s:purple, s:ultrablack)
call piccolo#Color('Constant', s:sea, s:ultrablack)
...
call piccolo#Color('FoldColumn', s:white, s:black)
call piccolo#Color('Folded', s:white, s:black)
call piccolo#Color('Function', s:darkgreen)
...
call piccolo#Color('Operator', s:gold)
...
call piccolo#Color('SpellCap', s:none, s:none, 'undercurl')
call piccolo#Color('SpellLocal', s:black, s:darkgreen)
